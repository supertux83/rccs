...
# oms_transmission_data <- load_oms_data() ##NOT WORKING
```
...
fig <- rccs_ggplot_inc_plot(current_confirmed, iso3c_country_code = c("FRA", "DEU"), smoothing = TRUE, smoothing_by_ma = TRUE, ma_n_days = 3)
```
